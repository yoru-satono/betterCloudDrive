...
Locator:  locator('text=e2e_folder_1780992678865')
...
Call log:
  ...
  - waiting for locator('text=e2e_folder_1780992678865')
    14 × locator resolved to <span data-v-a66bf268="" class="file-name-text truncate">e2e_folder_1780992678865</span>
       - unexpected value "visible"

```

```yaml
- text: e2e_folder_1780992678865
```
