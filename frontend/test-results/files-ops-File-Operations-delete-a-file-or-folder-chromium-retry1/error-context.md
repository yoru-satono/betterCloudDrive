...
Locator:  locator('text=del_1780992688411')
...
Call log:
  ...
  - waiting for locator('text=del_1780992688411')
    14 × locator resolved to <span data-v-a66bf268="" class="file-name-text truncate">del_1780992688411</span>
       - unexpected value "visible"

```

```yaml
- text: del_1780992688411
```
